...
if(isset($_POST['action'])) {
	switch ($_POST['action']) {
		...
		.topButImg{float:right;margin-right:20px;width:40px;height:40px;border:0;border-radius:2px;opacity:.8;background:<?php echo $bgc; ?> url(uno/plugins/top_button/top-arrow.svg) no-repeat center 50%;
		</style>
		<div id="topButton" class="blocForm">
			...
			<table class="hForm">
				<tr>
					...
					<td><input type="text" class="input color" name="topButtonCol" id="topButtonCol" style="width:100px;" value="<?php echo $bgc; ?>" /><span class="del" onclick="f_delColor_topButton(this);"></span></td>
